...
<main class="flex grow p-5">
    ...
    <div class="w-full lg-xl2-w-50 mt-24 ml-[330px] flex flex-col items-center justify-center">

        <p class="text-white text-3xl font-bold mb-4 mt-3">Edit User Form</p>
        ...
        <span class="flex flex-wrap w-[600px]">
            ...
            <span class="w-full mt-4 flex flex-row xs:flex-col sm:flex-col items-center justify-end space-x-4 xs:space-x-0 sm:space-x-0 xs:justify-center sm:justify-center">
                <button 
                    name="btn-add-userEdit" 
                    id="btn-add-user" 
                    class="px-4 py-2 xs:mb-4 sm:mb-4 xs:w-full sm:w-full bg-third text-white text-md font-semibold rounded-lg shadow-2xl hover:bg-blue-300 hover:text-third">
                    Add User
                </button>
                <a href="/tatsystem/admin/registration.view.php">
                <button 
                    name="btn-cancel-add-userEdit"  
