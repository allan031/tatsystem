...
<main class="flex grow p-5 mt-24 ml-[300px]">
    <div class="w-full">
        <p class="text-white text-3xl font-bold mb-4 text-left" id="rpttitle">TAT Summary</p>
        <hr class="h-px my-4 bg-white border-0">
        <div class="flex justify-end mb-2">
            <button type="submit" id="btn-export-tat" name="btn-export-tat" class=" bg-blue-500 border-2 border-third h-8 w-40 text-sm rounded-md hover:bg-blue-300 text-white">Export</button>
        </div>
        <div id="normal-table-tat-sum" class="flex flex-col items-center justify-end mb-3">
            <?php $transaction->TATSummaryDataTablev2();?>
            <div id="searchresult" class="w-full hidden">
...
<script type="text/javascript" src="../assets/js/tat.summary.js" defer></script>
